...
def create_basic_answer(question, best_match):
    """
    Creates a simple source-based answer.
    Later this will be replaced by AI-generated answers.
    """
    return f"""
CyberLex Sweden found a trusted source related to your question.

**Your question:** {question}

**Best matching source:** `{best_match["filename"]}`

**Relevance score:** {best_match["score"]}

This prototype is currently using keyword-based document search. The answer is not generated by AI yet. The system is showing the most relevant trusted source so the user can inspect the legal information directly.
"""
...
if question:
    ...
    if search_results:
        ...
        st.subheader("Source-Based Result")
